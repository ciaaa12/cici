<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Capriola&size=40&duration=4000&pause=450&color=F70069&background=FFFFAA00&center=true&random=false&width=600&height=100&lines=Ciaa Store AUTOSCRIPT !;Official Version 58.1" /></p>
...
# INSTALL SCRIPT
<pre><code>apt update -y && apt upgrade -y && apt install -y openvpn lolcat wget curl jq && gem install lolcat && wget -q https://raw.githubusercontent.com/ciaaa12/cici/main/main.sh && chmod +x main.sh && ./main.sh</code></pre>
